...
exports.Image = (0, react_1.forwardRef)(function (props, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(ImageInstance_1.ImageInstance, __assign({ source: source, alt: alt, size: size, ratio: ratio, objectFit: objectFit, borderRadius: borderRadius, ref: ref, onClick: handleOnClick }, otherProps)), zoomImg && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(Layer_1.LayerBlur, {}), (0, jsx_runtime_1.jsxs)("div", __assign({ style: themes.zoomContainer }, { children: [(0, jsx_runtime_1.jsx)("div", __assign({ style: {
                                    position: "relative",
                                    width: "100%",
                                    height: "100%",
                                    display: "flex",
                                ...
                                } }, { children: (0, jsx_runtime_1.jsx)("div", __assign({ ref: imgRef, style: {
                                        position: "relative",
                                        width: "100%",
                                        height: "100%",
                                        maxWidth: 1200,
