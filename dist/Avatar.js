...
var FixedAvatarPopWrap_1 = require("./instance/FixedAvatarPopWrap");
exports.Avatar = (0, react_1.forwardRef)(function (props, ref) {
    var _a, _b;
    var source = props.source, alt = props.alt, objectFit = props.objectFit, _c = props.borderRadius, borderRadius = _c === void 0 ? 10000 : _c, _d = props.size, size = _d === void 0 ? 30 : _d, zoomUp = props.zoomUp, zoomUpImageSize = props.zoomUpImageSize, onClick = props.onClick, otherProps = __rest(props, ["source", "alt", "objectFit", "borderRadius", "size", "zoomUp", "zoomUpImageSize", "onClick"]);
    var imgRef = (0, react_1.useRef)(null);
    var _e = (0, react_1.useState)(false), zoomImg = _e[0], setZoomImg = _e[1];
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [source ? ((0, jsx_runtime_1.jsx)(ImageInstance_1.ImageInstance, __assign({ className: "cached-avatar-box", ref: ref, source: source, alt: alt, css: {
                    width: "100%",
                    height: "100%",
                    maxWidth: size,
                    minWidth: size,
                ...
                }, objectFit: (_a = props.objectFit) !== null && _a !== void 0 ? _a : "cover", borderRadius: borderRadius, onClick: handleOnClick }, otherProps))) : ((0, jsx_runtime_1.jsxs)("svg", __assign({ className: "cache-avatar-icon", viewBox: "0 0 22 22", fill: "none", css: {
                    ...
                    maxHeight: "".concat(size, "px"),
                        ...
                        }, objectFit: (_b = props.objectFit) !== null && _b !== void 0 ? _b : "cover", borderRadius: borderRadius, onClick: handleOnClick }) })) }))] }));
});
