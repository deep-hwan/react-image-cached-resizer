...
import React, { ForwardedRef, ImgHTMLAttributes, SVGProps, forwardRef, useEffect, useRef, useState } from 'react';
...
export const Avatar = forwardRef((props: ImagePropsWithoutSize, ref: ForwardedRef<HTMLImageElement>) => {
  const {
    source,
    alt,
    objectFit,
